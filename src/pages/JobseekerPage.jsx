        ...
        <div className="container mx-auto mb-8 px-4">
          <div className="mx-auto max-w-3xl">
            <div className="mb-8 text-center">
              <h1 className="mb-3">Practice Interview Questions</h1>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Upload your resume and customize your interview questions
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="card mb-8 glassmorphism">
                <h2 className="mb-6 text-xl font-bold">1. Upload Your Resume</h2>
                <ResumeUploader />
              </div>
